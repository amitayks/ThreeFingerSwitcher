...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationShouldTerminate(_ sender: NSApplication) -> NSApplication.TerminateReply {
        ...
        // Clipboard persistence is asynchronous (a serial I/O queue); the process must not exit with
        // the last copy / pin toggle still queued — `flush()` had no caller before this.
        coordinator?.flushClipboardHistory()
