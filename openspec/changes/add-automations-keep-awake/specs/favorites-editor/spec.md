...
#### Scenario: Add an automation from the source picker
- **WHEN** the user chooses the Automations source and picks one (e.g. Keep Awake)
- **THEN** that automation item is added to the currently targeted band, titled with the automation's name, and selected
