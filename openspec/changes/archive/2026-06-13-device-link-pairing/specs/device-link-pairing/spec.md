...
#### Scenario: A wrong code aborts pairing
- **WHEN** confirmation fails for a code attempt
- **THEN** the pairing is aborted (a single attempt), not retried in a loop, to resist online guessing of the low-entropy code
